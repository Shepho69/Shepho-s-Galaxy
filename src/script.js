...
parameters.generateGalaxy = () => {
    ...
    generateGalaxy(position)

    console.log("Galaxy added", position)
...
gui.add(parameters, 'warp0').min(-5).max(5).step(0.001).onFinishChange(generateGalaxy)

gui.add(parameters, 'warp2').min(-5).max(5).step(0.001).onFinishChange(generateGalaxy)
...
gui.add(parameters, 'generateGalaxy')
